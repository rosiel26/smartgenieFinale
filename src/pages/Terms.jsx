      ...
      <div className="bg-white w-[380px] h-[720px] rounded-3xl shadow-2xl overflow-auto flex flex-col border border-green-100">
        ...
        <div className="p-5 flex-1 overflow-auto space-y-5 text-gray-700 text-sm">
          <section className="bg-green-50 p-4 rounded-xl shadow-sm">
            ...
            <p>
              Welcome to Smart Genie. By accessing or using this app, you agree
          ...
          <section className="bg-green-50 p-4 rounded-xl shadow-sm">
            ...
            <p>
              ...
              only. Any misuse of the app, including sharing copyrighted
              material or harmful content, is strictly prohibited.
            </p>
          </section>
          ...
          <section className="bg-green-50 p-4 rounded-xl shadow-sm">
            ...
            <p>
              ...
              Keep your login information secure and notify us of any
              unauthorized access.
            </p>
          </section>
          ...
          <section className="bg-green-50 p-4 rounded-xl shadow-sm">
            ...
            <p>
              All content, recipes, images, and trademarks on Smart Genie are
              the property of the app or its licensors. You may not copy,
